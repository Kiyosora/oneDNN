...
void jit_aarch64_sve_512_common_lrn_kernel_bwd_nhwc_t<d_type>::store_compute_data(
    ...
    if (tail_proc == tail_mode::CurrentTail) {
        ...
        this->CodeGeneratorAArch64::tst(Xbyak::Xbyak_aarch64::XReg(this->diffsrc_.getIdx()), this->vlen - 1);
        this->CodeGeneratorAArch64::cmp(Xbyak::Xbyak_aarch64::XReg(this->diffsrc_.getIdx()), 0);
